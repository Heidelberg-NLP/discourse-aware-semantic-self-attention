...
@DatasetReader.register("narrativeqa_summary_with_questions_semantic_optimized")
class NarrativeQASummaryWithQuestionsSemanticsReaderOptimized(DatasetReader):
    """
    ...
    def __init__(self,
                 ...
                 srl_views_extractor: SRLFlatViews = None,
