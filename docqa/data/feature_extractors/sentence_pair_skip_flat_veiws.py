...
@TokenWiseInteractionFeatureExtractor.register("sentence_pair_skip_flat_views")
class SentencePairSkipFlatViews(TokenWiseInteractionFeatureExtractor):
    def __init__(self,
                 skip: int,
                 max_views: int,
                 labels_start_id: int = 1,
                 namespace: str = "sent_pair_skip_flat",
    ...
    def extract_features(self, inputs):
        ...
        src_feats, sent_mask = generate_flat_feats_and_mask(inputs, self._skip, self._labels_start_id)
