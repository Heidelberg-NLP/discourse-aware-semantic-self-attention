...
from docqa.allennlp_custom.utils.evaluation_bleu import eval_bleu_batch_by_type
from docqa.nn.util import to_cuda

logger = logging.getLogger(__name__)  # pylint: disable=invalid-name


@Model.register("bidaf_basic")
class BidirectionalAttentionFlowBasic(Model):
    """
    ...
    With this extension we want to add typed relations between tokens in the sequence.
