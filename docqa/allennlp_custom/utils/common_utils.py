...
from docqa.utils.processing_utils import try_set_val_by_hier_key, clean_split
...
def is_output_meta_supported(module_object):
    if hasattr(module_object, "return_output_meta_is_supported") \
        and module_object.return_output_meta_is_supported:
        return True
    else:
        return False
