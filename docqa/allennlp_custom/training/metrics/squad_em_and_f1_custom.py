...
@Metric.register("squad_custom")
class SquadEmAndF1Custom(Metric):
    """
    ...
    @overrides
    def __call__(self, best_span_string, answer_strings, return_score=True):
        """
        Parameters
        ----------
        value : ``float``
        ...
        """
        exact_match = float(squad_eval.metric_max_over_ground_truths(
