...
@Seq2SeqEncoder.register("qanet_semantic_encoder")
class QaNetSemanticEncoder(Seq2SeqEncoder):
    """
    ...
    def __init__(self,
        ...
        self._encoder_blocks: List[QaNetSemanticEncoderBlock] = []
        for block_index in range(num_blocks):
            encoder_block = QaNetSemanticEncoderBlock(hidden_dim,
                                                      hidden_dim,
...
@Seq2SeqEncoder.register("qanet_semantic_encoder_block")
class QaNetSemanticEncoderBlock(Seq2SeqEncoder):
    """
    ...
    def __init__(self,
        ...
        self.attention_layer = MultiHeadSemanticSelfAttention(num_heads=num_attention_heads,
    ...
    def forward(self, 
        ...
        if self._replace_zero_semantic_labels_with_per_head_labels:
            ...
            attention_head_mask = torch.cat([torch.full(views_shape_single_head, x).long()
            ...
            semantic_views_k = semantic_views_k + attention_head_mask * (semantic_views_k < 1).long()
